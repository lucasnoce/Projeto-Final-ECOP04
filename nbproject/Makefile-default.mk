...
SOURCEFILES_QUOTED_IF_SPACED=adc.c io.c keypad.c lcd.c serial.c timer.c main_projeto.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/main_projeto.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/io.p1.d ${OBJECTDIR}/keypad.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/timer.p1.d ${OBJECTDIR}/main_projeto.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/main_projeto.p1

# Source Files
SOURCEFILES=adc.c io.c keypad.c lcd.c serial.c timer.c main_projeto.c
...
${OBJECTDIR}/main_projeto.p1: main_projeto.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main_projeto.p1.d 
	@${RM} ${OBJECTDIR}/main_projeto.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/main_projeto.p1 main_projeto.c 
	@-${MV} ${OBJECTDIR}/main_projeto.d ${OBJECTDIR}/main_projeto.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/main_projeto.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
