...
void checarLCD(){
  if (!((flag) & (1<<(7))) && ((flag) & (1<<(6)))){
    ((TRISB) &= ~(1<<(7)));
    ((PORTB) &= ~(1<<(7)));
    print(-1);
    ((flag) &= ~(1<<(6)));
  }
  else if (((flag) & (1<<(7))) && !((flag) & (1<<(6)))){
    print(bpm);
    ((flag) |= (1<<(6)));
  }
}
...
void main(void){
  ...
  for(;;){
    ...
    switch (valorTeclado){
      case 0: break;
      case 8: tocarSom(40); break;
      case 128: tocarSom(48); break;
      case 2048: tocarSom(62); break;
      case 4: tocarSom(63); break;
      case 64: tocarSom(71); break;
      case 1024: tocarSom(73); break;
      case 2: tocarSom(76); break;
      case 32: tocarSom(80); break;
      case 512: tocarSom(81); break;
      case 1: if (bpm > 1) bpm--;
                 else bpm = 1;
                 ((flag) &= ~(1<<(6)));
                 countMetronMax = 60000/(5*bpm);
                 break;
      case 16: for (int i=0; i<100; i++);
                 ((flag) ^= (1<<(7)));
                 break;
      case 256: if (bpm < 300) bpm++;
                 else bpm = 300;
                 ((flag) &= ~(1<<(6)));
                 countMetronMax = 60000/(5*bpm);
                 break;
